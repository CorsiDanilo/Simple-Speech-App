...
Java_com_anomalyzed_simplespeechkeyboard_whisper_NativeWhisper_00024Companion_initContext(
        JNIEnv *env,
        jobject thiz,
...
Java_com_anomalyzed_simplespeechkeyboard_whisper_NativeWhisper_00024Companion_freeContext(
        JNIEnv *env,
        jobject thiz,
        jlong context_ptr
) {
...
Java_com_anomalyzed_simplespeechkeyboard_whisper_NativeWhisper_00024Companion_fullTranscribe(
        JNIEnv *env,
        jobject thiz,
        jlong context_ptr,
        jint num_threads,
...
extern "C" JNIEXPORT jint JNICALL
Java_com_anomalyzed_simplespeechkeyboard_whisper_NativeWhisper_00024Companion_getTextSegmentCount(
        JNIEnv *env,
        jobject thiz,
        jlong context_ptr
) {
...
Java_com_anomalyzed_simplespeechkeyboard_whisper_NativeWhisper_00024Companion_getTextSegment(
        JNIEnv *env,
        jobject thiz,
        jlong context_ptr,
        jint index
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_anomalyzed_simplespeechkeyboard_whisper_NativeWhisper_00024Companion_getSystemInfo(
        JNIEnv *env,
        jobject thiz
) {
    UNUSED(thiz);
